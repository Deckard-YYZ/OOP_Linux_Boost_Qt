...
\DoxyHorRuler{0}
\hypertarget{md_README_autotoc_md1}{}\doxysubsection{Edit a file}\label{md_README_autotoc_md1}
...
\DoxyHorRuler{0}
\hypertarget{md_README_autotoc_md3}{}\doxysubsection{Create a file}\label{md_README_autotoc_md3}
...
\DoxyHorRuler{0}
\hypertarget{md_README_autotoc_md5}{}\doxysubsection{Clone a repository}\label{md_README_autotoc_md5}
