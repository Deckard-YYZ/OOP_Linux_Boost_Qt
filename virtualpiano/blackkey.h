/*
 * @brief the class represent black piano key
 ...
 * Any key press event in GUI will trigger the corresponding  blackkey's QSoundEffect Object play sound.
 * @author YUNZHUO ZHANG, ZINAN GONG
 */

#ifndef VIRTUALPIANO_BLACKKEY_H
#define VIRTUALPIANO_BLACKKEY_H
#include"Pianokey.h"
#include <QMainWindow>
#include <QPushButton>
 ...
 * @param piano_tune  for the initial tune index of the this blackkey
 */
...
/*
 * @brief the funcion change the geo of the black key at runtime
 * @param x,y,w,h for x-axis,y-axis,width and height 
 */    
